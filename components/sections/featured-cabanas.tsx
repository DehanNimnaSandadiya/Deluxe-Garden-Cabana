        ...
        <div className="mt-10 grid gap-8 md:grid-cols-3">
          {featured.map((cabana, index) => (
            <motion.article
              ...
              className="group flex flex-col overflow-hidden rounded-3xl border border-white/40 bg-white/70 shadow-subtle backdrop-blur-sm"
            >
              ...
              <div className="flex flex-1 flex-col px-5 pb-5 pt-4">
                ...
                <Link href={`/cabanas/${cabana.slug}`} className="sr-only">
                  View cabana
                </Link>
              </div>
            </motion.article>
